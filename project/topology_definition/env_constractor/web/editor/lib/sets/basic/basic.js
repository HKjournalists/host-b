...
function figure_Rectangle(x, y)
{
    ...
    //wb mod
    f.devType = "Switch";
    f.serial = f.devType + f.id;
    f.props = new SwitchProps();
    f.props.name = f.serial;
    //mod end
    ...
    */
    ...
    //wb mod : add self properties
    f.properties.push(new BuilderProperty('IP Address', 'props.ip',BuilderProperty.SW_IP));
    f.properties.push(new BuilderProperty('Host Name', 'props.name',BuilderProperty.SW_NAME));
    f.properties.push(new BuilderProperty('UserName', 'props.userName',BuilderProperty.SW_USERNAME));
    f.properties.push(new BuilderProperty('Password', 'props.passwd',BuilderProperty.SW_PASSWD));
    f.properties.push(new BuilderProperty('l2 interface', 'props.l2ifs',BuilderProperty.SW_L2IF));
    f.properties.push(new BuilderProperty('l3 interface', 'props.l3ifs',BuilderProperty.SW_L3IF));
    f.properties.push(new BuilderProperty('route info', 'props.staticRoute',BuilderProperty.SW_STATIC_ROUTE));
    
    /*特殊属性，用于生成读取信息的按钮（废弃）
    f.properties.push(new BuilderProperty('sinfo', 'props.sinfo',BuilderProperty.SW_INFO));*/
...
//    r.style.lineJoin = r.style.STYLE_LINE_JOIN_MITER;
    ...
    var t2 = new Text(f.serial, x + FigureDefaults.segmentSize/2, y + rectangleHeight/2, FigureDefaults.textFont, FigureDefaults.textSize);
...
//    f.properties.push(new BuilderProperty(BuilderProperty.SEPARATOR));
    ...
    */
    ...
    //wb mod : add self properties
    f.properties.push(new BuilderProperty('IP Address', 'props.ip',BuilderProperty.SVR_IP));
    f.properties.push(new BuilderProperty('Host Name', 'props.name',BuilderProperty.SVR_NAME));
    f.properties.push(new BuilderProperty('UserName', 'props.userName',BuilderProperty.SVR_USERNAME));
    f.properties.push(new BuilderProperty('Password', 'props.passwd',BuilderProperty.SVR_PASSWD));
    f.properties.push(new BuilderProperty('Interface', 'props.ifs',BuilderProperty.SVR_IFS));
    f.properties.push(new BuilderProperty('route info', 'props.staticRoute',BuilderProperty.SVR_STATIC_ROUTE));
    ...
    var t2 = new Text(f.serial, x + FigureDefaults.segmentSize/2, y + FigureDefaults.segmentShortSize/2 + FigureDefaults.corner, FigureDefaults.textFont, FigureDefaults.textSize);
    t2.style.fillStyle = FigureDefaults.textColor;
